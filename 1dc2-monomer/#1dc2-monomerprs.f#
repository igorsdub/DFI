...
C	connected
	OPEN(99,FILE='1dc2-monomerinput.parms')
...
C	the 1st is the structure to be perturbed, the 2nd is the target 
	OPEN(50,FILE='1dc2-monomer-CA.pdb')
	OPEN(51,FILE='1dc2-monomer-CA.pdb')
...
c	open(20,file='uf-hessianPF.txt')
	...
	open(61,file='1dc2-monomer.delRinitial')
	OPEN(66,FILE='eigenvalues.txt')
	open(69,file='1dc2-monomer_RESULTS.txt')
	OPEN(71,FILE='1dc2-monomer_diffbest.txt')
	OPEN(72,FILE='1dc2-monomer_dev_corr.txt')
	...
	open(88,file='1dc2-monomer-S2-Avg.dat')
	open(89,file='1dc2-monomer-S2-Max.dat')
	open(90,file='1dc2-monomer-S1-Avg.dat')
	open(91,file='1dc2-monomer-S1-Max.dat')

	open(15,file='1dc2-monomer-ResponseVector-Magnitude-Avg.dat')
	open(16,file='1dc2-monomer-ResponseVector-Magnitude-Max.dat')
