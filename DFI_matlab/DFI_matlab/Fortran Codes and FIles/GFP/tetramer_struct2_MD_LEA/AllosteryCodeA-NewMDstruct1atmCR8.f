...
C############################################################
	OPEN(50,FILE='4DXN_C1_struct_atmorder.pdb')
	OPEN(51,FILE='4DXN_C1_struct_atmorder.pdb')
C############################################################
C   Input file for covariance matrix if MD data is used
        OPEN(81,FILE='4DXNmwcovarmat.dat')
...
c *******output files
	...
	open(61,file='4DXN.delRinitial')
	OPEN(66,FILE='eigenvalues.txt')
	open(69,file='4DXN_RESULTS.txt')
	OPEN(71,FILE='4DXN_diffbest.txt')
	OPEN(72,FILE='4DXN_dev_corr.txt')
...
c X -direction 
c ********************
	open(27,file='4DXN_X_BindSumRows.dat')
	open(28,file='4DXN_X_AllSumColumn.dat')

c ********************
c Y -direction 
c ********************
	open(31,file='4DXN_Y_BindSumRows.dat')
	open(32,file='4DXN_Y_AllSumColumn.dat')

c ********************
c Z -direction 
c ********************
	open(35,file='4DXN_Z_BindSumRows.dat')
	open(36,file='4DXN_Z_AllSumColumn.dat')


c ********************
c  XY -direction 
c ********************
	open(39,file='4DXN_XY_BindSumRows.dat')
	open(40,file='4DXN_XY_AllSumColumn.dat')

c ********************
c  XZ -direction 
c ********************
	open(43,file='4DXN_XZ_BindSumRows.dat')
	open(44,file='4DXN_XZ_AllSumColumn.dat')

c ********************
c  YZ -direction 
c ********************
	open(47,file='4DXN_YZ_BindSumRows.dat')
	open(48,file='4DXN_YZ_AllSumColumn.dat')

c ********************
c  XYZ -direction 
c ********************
	open(54,file='4DXN_XYZ_BindSumRows.dat')
	open(55,file='4DXN_XYZ_AllSumColumn.dat')

	open(11,file='4DXN.BindRatio_all_directions.txt')
	open(12,file='4DXN_MaxAR.txt')
...
C******************************************************************
C  IMPORT COVARIANCE MATRIX AS HESSIAN MATRIX FROM MD DATA
C******************************************************************

        READ(81,*)((INVBKBT(J,D),D=1,RES3),J=1,RES3)
c       write(*,*)((HESS(J,D),D=1,10),J=1,10)
        CLOSE(81)
