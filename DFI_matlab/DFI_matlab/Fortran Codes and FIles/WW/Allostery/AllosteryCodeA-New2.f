...
C############################################################
	PARAMETER (NR=23,GAMMA=2.0,nbG=1)
C############################################################
...
C############################################################
	OPEN(50,FILE='cc45ww.pdb')
	OPEN(51,FILE='cc45ww.pdb')
C############################################################
...
c *******output files
	...
	open(61,file='1YMZ.delRinitial')
	OPEN(66,FILE='eigenvalues.txt')
	open(69,file='1YMZ_RESULTS.txt')
	OPEN(71,FILE='1YMZ_diffbest.txt')
	OPEN(72,FILE='1YMZ_dev_corr.txt')
...
c X -direction 
c ********************
	open(27,file='1YMZ_X_BindSumRows.dat')
	open(28,file='1YMZ_X_AllSumColumn.dat')

c ********************
c Y -direction 
c ********************
	open(31,file='1YMZ_Y_BindSumRows.dat')
	open(32,file='1YMZ_Y_AllSumColumn.dat')

c ********************
c Z -direction 
c ********************
	open(35,file='1YMZ_Z_BindSumRows.dat')
	open(36,file='1YMZ_Z_AllSumColumn.dat')


c ********************
c  XY -direction 
c ********************
	open(39,file='1YMZ_XY_BindSumRows.dat')
	open(40,file='1YMZ_XY_AllSumColumn.dat')

c ********************
c  XZ -direction 
c ********************
	open(43,file='1YMZ_XZ_BindSumRows.dat')
	open(44,file='1YMZ_XZ_AllSumColumn.dat')

c ********************
c  YZ -direction 
c ********************
	open(47,file='1YMZ_YZ_BindSumRows.dat')
	open(48,file='1YMZ_YZ_AllSumColumn.dat')

c ********************
c  XYZ -direction 
c ********************
	open(54,file='1YMZ_XYZ_BindSumRows.dat')
	open(55,file='1YMZ_XYZ_AllSumColumn.dat')

	open(11,file='1YMZ.BindRatio_all_directions.txt')
	open(12,file='1YMZ_MaxAR.txt')
        open(99,file='1YMZ_INVBKBT.txt')
...
C******************************************************************
	...
	IF(JJJ.GT.0)WRITE(*,*) 'NEGATIVE ELEMENTS IN THE DIAGONAL:',JJJ
       ...
       Do I=1,RES3
          DO J=1,RES3
             write(99,*) INVBKBT(I,J)
          ENDDO
       ENDDO
       write(*,*) 'INVBKBT IS WRITTEN'
...
c- this part is the numerator part of Equation 10 in Gerek and Ozkan, Plos Comp Biol, 2011 paper
	   DO i=1,RESNUM
	   sum = 0.0
		DO j=1,RESNUM
